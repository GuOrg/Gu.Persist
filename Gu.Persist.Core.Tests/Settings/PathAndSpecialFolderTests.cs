namespace Gu.Persist.Core.Tests.Settings
{
    using System;
    ...
    public class PathAndSpecialFolderTests
    {
        ...
        public void DefaultFor()
        {
            ...
            Assert.AreEqual(Environment.SpecialFolder.ApplicationData, pathAndSpecialFolder.SpecialFolder);
            Assert.AreEqual("Gu.Persist.Core.Tests", pathAndSpecialFolder.Path);
            var expected = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Gu.Persist.Core.Tests");
            Assert.AreEqual(expected, pathAndSpecialFolder.CreateDirectoryInfo().FullName);
        }
