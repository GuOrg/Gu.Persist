namespace Gu.Settings.Core.Tests.AutoSaver
{
    using System;
    ...
    public class AutoSaverTests
    {
        ...
        private Mock<IAutoSavingRepository> _repositoryMock;
        ...
        public void SetUp()
        {
            ...
            _repositoryMock = new Mock<IAutoSavingRepository>();
            _autoSaver = new AutoSaver(_repositoryMock.Object);
